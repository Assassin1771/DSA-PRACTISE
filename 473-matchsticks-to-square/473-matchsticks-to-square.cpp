// https://leetcode.com/problems/matchsticks-to-square/discuss/1273756/C%2B%2B-Simple-and-Clean-Backtracking-Commented-Solution
...
public:
    ...
    {
        if (k == 1) // if k == 1 then we found all subsets, already found 3, 4 has to be there
            return true;
